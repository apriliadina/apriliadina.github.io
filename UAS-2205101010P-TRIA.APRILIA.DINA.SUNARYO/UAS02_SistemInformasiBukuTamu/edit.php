...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Edit Data Tamu</h1>
	...
	?>
                        ...
                        <form action = "edit_aksi.php" method = "post"> 
                                        ...
                                        <h4>ID Tamu</h4>
                                        <input type="text" class="form-control" id="id" name="id" value="<?php echo $d['id']; ?>">
                                        <br>
                                        ...
                                        <h4>Nomor Telp.</h4>
                                        <input type="text" class="form-control" id="no_telp" name="no_telp" value="<?php echo $d['no_telp']; ?>">
                                        <br>

                                        <h4>Tanggal Datang</h4>
                                        <input type="date" class="form-control" id="tgl" name="tgl" value="<?php echo $d['tgl']; ?>">
                                        <br>

                                        <h4>Pesan</h4>
                                        <textarea class="form-control"   rows="2" id="pesan" name="pesan" value="<?php echo $d['pesan']; ?>"></textarea>
                                        <br>                                   
